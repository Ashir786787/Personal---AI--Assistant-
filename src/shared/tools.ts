...
export const TOOL_PROTOCOL_INSTRUCTIONS = [
  ...
  '- launch_app {"app": "notepad"} — propose launching an approved app (Notepad, Calculator, File Explorer, Paint, Microsoft Edge, Google Chrome, VS Code, Task Manager, Spotify)',
  'Rules:',
